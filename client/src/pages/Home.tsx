...
export default function Home() {
  ...
  const savedAmbients = (() => {
    try { return JSON.parse(localStorage.getItem('brown_noise_ambients') || '[]'); } catch { return []; }
  })();
  ...
  const {
    ...
    toggleAmbient,
    stopWithFade
  } = useAudioEngine(savedVolume, savedAmbients);
  ...
  useEffect(() => {
    localStorage.setItem('brown_noise_ambients', JSON.stringify(activeAmbients));
  }, [activeAmbients]);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <DialogContent className="bg-secondary/95 backdrop-blur border-white/10 text-foreground max-w-sm">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-muted-foreground pt-2">
                        ...
                        <br/><br/>
                        Layer ambient sounds on top of the brown noise base for a personalized soundscape. You can select multiple ambient layers at once.
                        <br/><br/>
      ...
      <main className="w-full max-w-md flex flex-col items-center gap-12 z-10 pt-16">
        ...
        <div className="w-full space-y-8 bg-white/5 backdrop-blur-sm p-6 md:p-8 rounded-3xl border border-white/5 shadow-xl">
            ...
            <AmbientSounds activeAmbients={activeAmbients} onToggle={toggleAmbient} />
      ...
      <footer className="mt-8 mb-6 text-xs text-muted-foreground/40 font-mono">
